...
export default class FluxMedicationObjectFactory {
    static createInstance(json, type, patientRecord) {
        ...
        switch (elementName) {
            ...
            case 'MedicationAfterChange': return new FluxMedicationAfterChange(json, patientRecord);
            case 'MedicationBeforeChange': return new FluxMedicationBeforeChange(json, patientRecord);
